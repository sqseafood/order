  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-gray-50 px-4">
      <div className="w-full max-w-sm">
        <h1 className="text-2xl font-bold text-gray-900 mb-1 text-center">Order Processing</h1>
        <p className="text-sm text-gray-500 text-center mb-8">SeaQuest Seafood — Staff Only</p>
